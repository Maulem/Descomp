...
architecture arch_name of Decoder is
  ...
  alias tipor    : std_logic is OUTPUT(4);
  alias ula_mux  : std_logic is OUTPUT(5);
  alias rd_wr    : std_logic is OUTPUT(6);
  alias mux_addr : std_logic is OUTPUT(7);
  alias mux_jump : std_logic is OUTPUT(8);
