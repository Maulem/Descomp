...
-- Equation(s):
-- \ROM1|memROM~5_combout\ = (!\REG_MEF|DOUT\(2) & ((!\REG_MEF|DOUT\(0)))) # (\REG_MEF|DOUT\(2) & (!\REG_MEF|DOUT\(1)))
...
-- Equation(s):
-- \ROM1|memROM~3_combout\ = (!\REG_MEF|DOUT\(2) & (\REG_MEF|DOUT\(1) & \REG_MEF|DOUT\(0))) # (\REG_MEF|DOUT\(2) & (!\REG_MEF|DOUT\(1)))
